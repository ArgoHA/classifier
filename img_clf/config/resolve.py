...
Installed as a package: copy `default.yaml` (this file's neighbour) to ./config.yaml.
"""
...
ENV_VAR = "CLASSIFIER_CONFIG_DIR"
CONFIG_NAME = "config"

_HERE = Path(__file__).resolve().parent
DEFAULT_CONFIG = _HERE / "default.yaml"  # sanitized template, this file's neighbour
...
def find_config() -> Optional[Path]:
    ...
    A set-but-wrong $CLASSIFIER_CONFIG_DIR raises rather than falling through: training
